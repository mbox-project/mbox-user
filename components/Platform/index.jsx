      ...
      <div className="">
        <div className="max-w-screen-xl px-4 py-0  md:py-8 lg:py-16 mx-auto  lg:px-8">
          <div className=" block lg:grid grid-cols-2 lg:gap-20 mt-2 lg:mt-3  lg:gap-y-16">
            ...
            <div className="">
              <h2 className="text-2xl lg:text-4xl poppins flex justify-center lg:block pt-5 md:pt-2 font-extrabold ">
                OUR{" "}
                <span className="text-orange-600 pl-2 lg:pl-0"> PLATFORM</span>
              </h2>
              <p className="  md:pl-0 md:block pt-4 lg:pt-8 poppins leading-relaxed">
              ...
              <p className="pl-3 md:pl-0 pt-6 md:pt-2 poppins lg:pt-10">
