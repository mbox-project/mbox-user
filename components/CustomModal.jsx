        ...
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div className="flex flex-col p-6">
            ...
            <p className="text-sm text-gray-500">
              Please, Understand that "Become a Merchant" requires you to update
              your account information on your profile. information like your
              store name, store address, bank acount details, would be required
              and a few other changes to your account.
            </p>
