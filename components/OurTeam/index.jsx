        ...
        <div className="max-w-screen-xl px-4 py-2 lg:mx-auto  lg:px-8">
          <div className=" block lg:grid lg:grid-cols-2 gap-20 mt-2 lg:mt-5  lg:gap-y-16">
            <div>
              ...
              <div className="  md:hidden Smt-14 lg:mt-0">
                <Image src={ourteamimg} />
              </div>
              <p className="flex justify-between md:justify-center poppins  font-medium md:block pt-4 lg:pt-8 leading-relaxed">
            ...
            <div className=" hidden md:flex Smt-14 lg:mt-0">
              <Image src={ourteamimg} />
            </div>
          </div>
        </div>
