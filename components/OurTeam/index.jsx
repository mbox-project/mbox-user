      ...
      <div>
        <div className="max-w-screen-xl px-4 py-2 lg:mx-auto  lg:px-8">
          <div className=" block lg:grid lg:grid-cols-2 gap-20 mt-2 lg:mt-5  lg:gap-y-16">
            <div>
              <h2 className="text-2xl lg:text-4xl poppins flex justify-center leading-relaxed lg:block pt-2 md:pt-2 font-extrabold ">
                OUR <span className="text-orange-600 pl-2 lg:pl-0"> TEAM</span>
              </h2>
              <p className="flex justify-center poppins  font-medium md:block pt-4 lg:pt-8 leading-relaxed">
              ...
              <p className="lg:pt-10 pt-4 poppins ">
                The zeal to transform E-commerce with our users in mind makes us
                better day by day.
              </p>
              <p className=" lg:pt-10 pt-4 lg:text-2xl font-semibold">
