            ...
            <div className="flex font-sans relative">
                ...
                <main className="px-4 container mx-auto md:px-20">
                    ...
                    <section className="flex flex-col-reverse bg-white rounded-lg px-10 py-2 items-center justify-between mt-10 shadow-sm  hover:shadow-md md:flex-row">
                        ...
                        <div>
                            <Image src={lady} className="w-20 rounded-full border-solid border-2 border-black-600" alt="profile-pics" />
                        </div>
                    </section>

                    {/* Second Section--banner */}
                    <section className="mt-4 text-center">
                        <Image src={banner} className="rounded-md object-cover" height={280} alt="Banner" />
                    </section>
                    ...
                    <section className="card mb-10">
                        <div className="mt-4 flex flex-col md:flex-row md:space-x-4">
                            <div className="md:basis-1/2">
                                ...
                                <div className="flex flex-col ">
                                    <div className="p-6 bg-white shadow-md">
                                        <h6 className="font-bold text-green-300">Top Merchant Endorsed</h6>
                                        <ul className="mt-4 space-y-2">
                                            ...
                                            <li className="flex items-center text-sm justify-between cursor-pointer hover:text-gray-600">
                                                <Link href="#"> Vero's Skincare products </Link>
                                                <Image src={caret} width={15} height={15} alt="profile" />
                                            </li>
                                            <li className="flex items-center text-sm justify-between cursor-pointer hover:text-gray-600">
                                    ...
                                    <div className="mt-8 mb-2 p-6 bg-white shadow-md">
                                        <h6 className="font-bold text-red-300">Top Merchant Endorsed</h6>
                                        <ul className="mt-4 space-y-2">
                                            <li className="flex items-center text-sm justify-between cursor-pointer hover:text-gray-600">
                                                <Link href="#"> Longshort Sneakers </Link>
                                                <Image src={caret} width={15} height={15} alt="profile" />
                            ...
                            <div className="md:basis-1/2">
                                ...
                                <div className="p-6 bg-brightPurple text-white shadow-md">
                                    <ul className="list-decimal mt-4 space-y-2">
