        ...
        <>
            <Layout>
                <div className="flex justify-between">
                    <h2 className="text-2xl mt-2 inline">Invoice</h2>
                </div>
                ...
                <div>
                    <form>
                        ...
                        <div className="relative mt-5">
                            ...
                            <input type="search" id="default-search" className="block w-auto p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search invoice here..." required />
                        </div>
                    </form>
                </div>
                            ...
                            <table className="w-full text-sm text-left text-gray-900">
                                ...
                                <tbody>
                                    <tr className="bg-white hover:bg-gray-5">
                                        ...
                                        <td className="px-6 py-4">
                                            <button className="py-2 px-3 text-sm focus:outline-none leading-none text-green-700 bg-green-100 rounded">Paid</button>
                                        </td>
                                        <td>
                                    ...
                                    <tr className="bg-white hover:bg-gray-5">
                                        ...
                                        <td className="px-6 py-4">
                                            <button className="py-2 px-3 text-sm focus:outline-none leading-none text-red-700 bg-red-100 rounded">Queried</button>
                                        </td>
                                        <td>
                                            <div className="flex justify-center align-middle">
                                                <span className="inline   ml-2 text-gray-300">
                                    ...
                                    <tr className="bg-white hover:bg-gray-5">
                                        ...
                                        <td className="px-6 py-4">
                                            <button className="py-2 px-3 text-sm focus:outline-none leading-none text-blue-700 bg-blue-100 rounded">Awaiting Payment</button>
                                        </td>
                                        <td>
                                            <div className="flex justify-center align-middle">
                                                <span className="inline   ml-2 text-gray-300">
                                    ...
                                    <tr className="bg-white hover:bg-gray-5">
                                        ...
                                        <td className="px-6 py-4">
                                            <button className="py-2 px-3 text-sm focus:outline-none leading-none text-[#444444] bg-[#9A9A9A] rounded">Void</button>
                                        </td>
                                        <td>
                                            <div className="flex justify-center align-middle">
                                                <span className="inline   ml-2 text-gray-300">
