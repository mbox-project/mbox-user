        ...
        <>
            <Layout>
                <div className="flex justify-between">
                    <h2 className="text-2xl mt-2 inline">Reviews</h2>
                </div>
                ...
                <div>
                    <form>
                        ...
                        <div className="relative mt-5">
                            ...
                            <input type="search" id="default-search" className="block w-auto p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search reviews here..." required />
                        </div>
                    </form>
                </div>
                ...
                <div className="w-full mt-8 bg-white rounded-lg shadow">
                    <div className="flex items-center justify-between p-5 border-b-2 border-gray-200">
                        <h4 className="text-xl font-bold leading-none">All Reviews</h4>
                        <div className="flex justify-between">
                                    ...
                                    <tr className="bg-white hover:bg-gray-5">
                                        ...
                                        <td>
                                            <div className="flex justify-center align-middle">
                                                <Button className=" my-4 rounded-md shadow-lg bg-brightRed p-2  text-white flex justify-center text-base poppins">
                                                    Details
                                                </Button>
                                            </div>
                                        </td>
